...
export const Header = ({title}: HeaderProps) => {
    ...
    const [ConfirmDialog, confirm] = useConfirm(
        "Delete this channel", "You are about to delete this channel. This action is irreversible."
    );
    ...
    const handleChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        const value = e.target.value.replace(/\s+/g, "-").toLowerCase(); //replace space with dash
        setValue(value);
    };
