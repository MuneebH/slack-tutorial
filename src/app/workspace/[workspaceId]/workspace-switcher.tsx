...
import { useCreateWorkspaceModal } from "@/src/features/workspaces/store/use-create-workspace-modal";
        ...
        <DropdownMenu>
            ...
            <DropdownMenuContent side="bottom" align="start" className="w-64">
                    <DropdownMenuItem
                        ...
                        className="cursor-point flex-col justify-start items-start capitalize"
                    >
                        {workspace?.name}
